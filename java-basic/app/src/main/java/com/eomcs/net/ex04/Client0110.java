...
public class Client0110 {
  public static void main(String[] args) {
    ...
    try (Socket socket = new Socket("192.168.0.40", 8888);
      ...
      do {
        ...
        out.println(name); // PrintWriter이기 때문에 println을 하여도 출력되지 않는다.
        out.flush(); // printWriter이기 때문에 반드시 flush() 메소드를 호출해야 한다.

        String str = in.readLine(); // 서버가 보낸 한 줄을 읽는다.
