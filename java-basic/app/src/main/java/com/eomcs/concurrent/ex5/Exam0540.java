...
public class Exam0540 {
  public static void main(String[] args) {
    ...
    Worker w2 = new Worker("유관순", job1);
    Worker w3 = new Worker("이순신", job1);
    Worker w4 = new Worker("임꺽정", job2);
    Worker w5 = new Worker("김구", job2);
    Worker w6 = new Worker("세종대왕", job2);
