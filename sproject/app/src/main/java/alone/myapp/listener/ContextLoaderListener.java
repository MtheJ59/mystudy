package alone.myapp.listener;

import alone.myapp.dao.ChatDao;
import alone.myapp.dao.AttachedFileDao;
import alone.myapp.dao.BoardDao;
import alone.myapp.dao.MemberDao;
import alone.myapp.dao.mysql.ChatDaoImpl;
import alone.myapp.dao.mysql.AttachedFileDaoImpl;
import alone.myapp.dao.mysql.BoardDaoImpl;
import alone.myapp.dao.mysql.MemberDaoImpl;
import alone.util.DBConnectionPool;
import alone.util.TransactionManager;
...
public class ContextLoaderListener implements ServletContextListener {
  ...
  public void contextInitialized(ServletContextEvent sce) {
    ...
    웹애플리케이션저장소.setAttribute("chatDao", chatDao);
