...
//  @Override
//  public Iterator<E> iterator() {
//    return new IteratorImlp<>(this);
//  }
//
//  private static class IteratorImlp<E> implements Iterator<E> {
//
//    ArrayList<E> list;
//    int cursor;
//
//    public IteratorImlp(ArrayList<E> list) {
//      this.list = list;
//    }
//
//    @Override
...
//  }
  ...
  // 3) 논 스태틱 중첩 클래스를 사용한 경우
//  @Override
//  public Iterator<E> iterator() {
//    return new IteratorImlp<>();
//  }
//
//  private class IteratorImlp<E> implements Iterator<E> {
//
//    int cursor;
//
//    @Override
...
//  public Iterator<E> iterator() {
//
//    // 로컬 클래스는 이 메소드 안에서만 사용할 수 있다.
//    class IteratorImlp<E> implements Iterator<E> {
//
